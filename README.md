...
| :--- | :--- | :--- | :--- | :--- |
| **Ridge Linear Regression ($L_2$)** | Median Imputation + Log Transform + Scaling + OHE | 0.1554 | Top 8% (~3,200) | ✅ Completed |
| **Random Forest Regressor** | Minimal (No scaling or OHE tracking needed) | *TBD* | *TBD* | 🛠️ In Progress |
